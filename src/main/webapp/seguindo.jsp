      ...
      <div class="container">
          <ul>
              ...
              <jsp:useBean id="dao" class="Dao.UserDao">
                  <c:forEach  varStatus="user.id" var="user" items="${dao.getUserThatIFollow(userId)}">
                      <c:if test="${userId != user.id}">
                          <li class="d-flex ">
                              ...
                              <div class="btnFollow" data-user-id="${user.id}">
                                  <a href="post?userId=${userId}&followedId=${user.id}&action=unfollow" style="color: white">
                                      Deixar de seguir
                                  </a>
