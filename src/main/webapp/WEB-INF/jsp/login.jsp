...
<div class="row formTemplate">
    ...
    <div class="right-area col-6 d-flex align-items-center flex-column justify-content-center">



        <form:form action="/api/auth" method="post" modelAttribute="user" cssClass="row flex-column align-items-center mx-auto gap-3 w-100">
        ...
        <p>Ainda não possui uma conta ? <a href="/api/cadastro" style="margin-top: 30px; color: purple">Cadastre-se</a></p>
    </div>
